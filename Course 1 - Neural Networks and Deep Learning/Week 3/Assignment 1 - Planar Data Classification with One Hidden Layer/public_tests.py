...
import numpy as np
from test_utils import multiple_test, single_test
...
def compute_cost_test(target):
    ...
    A3 = np.array([0.7, 0.3, 0.8, 0.9, 0.9]).reshape(1, 5)
...
def nn_model_test(target):
    ...
    expected_output = {
        ...
        "b1": np.array(
            [[0.00285386], [0.01642488], [-0.01114986], [-0.01656405], [0.01042274]]
        ),
        "W2": np.array(
            [[-1.45325879, -2.65768451, 2.26286606, 2.97274518, -2.18860534]]
        ),
